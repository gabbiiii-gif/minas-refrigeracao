...
function Automacao({clientes,addToast}) {
  ...
  const openSendModal=(cliente,templateKey)=>{
    ...
    const msg=fn(cliente.nome,"10/03/2026","14:00","Manutenção Preventiva","Carlos Silva");
    setMsgEdit(msg);
      ...
      <div className="app">
        ...
        <div className="main">
          <header className="topbar">
            <button className="menu-btn" onClick={()=>setSideOpen(!sideOpen)} style={{display:"flex"}}>
